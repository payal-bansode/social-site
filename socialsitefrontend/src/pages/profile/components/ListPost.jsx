...
const ListPost = ({ postDetail, likePost, deletePostFunc }) => {
    ...
    const handleUsernameClick = (username) => {
        console.log('navigate user to userprofile', username)
        navigate(`/${username}/`); // Navigate to user's profile page using their username
    };

    const handleDeleteClick = (post_id) => {
       
        deletePostFunc(post_id); // Navigate to user's profile page using their username
        handleClose()
    };
        ...
        <>
            ...
            <Dialog open={open} onClose={handleClose} fullWidth maxWidth="md">
                ...
                <DialogActions>
                    ...
                    {user.username===postDetail.created_by&&
                    <Button size='small' sx={{
                        ...
                        // color: '#262626',
                        //   borderColor: '#dbdbdb',
                    }} variant='outlined' onClick={() =>handleDeleteClick (postDetail.id)
                    } color="error">
                        Delete post
                    </Button>
